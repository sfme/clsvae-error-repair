        ...
        for cur_noise_lvl in "15" "25" "35" "45" ; do
            ...
            for cur_trustset_lvl in "5" "10" "25" "50" ; do
                ...
                for cur_run in "1" "2" "3" "4" "5" ; do
                    ...
                    # sh ./run_model.sh \
                    sbatch -J vae_noise_${cur_noise_lvl}_trust_${cur_trustset_lvl}_run_${cur_run} ./wrapper_cluster_run_model_bin.sh \
                        --dataset "simple_shapes" \
                        --model "VAE" \
                        --epochs "200" \
                        --run-number "${cur_run}" \
                        --noise-option "noisy_lines" \
        ...
        for cur_noise_lvl in "15" "25" "35" "45" ; do
            ...
            for cur_trustset_lvl in "5" "10" "25" "50" ; do
                ...
                for cur_run in "1" "2" "3" "4" "5" ; do
                    ...
                    # sh ./run_model.sh \
                    sbatch -J semi_Y_noise_${cur_noise_lvl}_trust_${cur_trustset_lvl}_run_${cur_run} ./wrapper_cluster_run_model_bin.sh \
                        --dataset "simple_shapes" \
                        --model "semi_y_VAE" \
                        --epochs "200" \
                        --run-number "${cur_run}" \
        ...
        for cur_noise_lvl in "15" "25" "35" "45" ; do
            ...
            for cur_trustset_lvl in "5" "10" "25" "50" ; do
                ...
                for cur_run in "1" "2" "3" "4" "5" ; do
                    ...
                    # sh wrapper_cluster_run_model.sh \
                    # sh ./run_model.sh \
                    sbatch -J cvae_noise_${cur_noise_lvl}_trust_${cur_trustset_lvl}_run_${cur_run} ./wrapper_cluster_run_model_bin.sh \
                        --dataset "simple_shapes" \
                        --model "full_y_CVAE" \
                        --epochs "200" \
                        --run-number "${cur_run}" \
        ...
        for cur_noise_lvl in "15" "25" "35" "45" ; do
            ...
            for cur_trustset_lvl in "5" "10" "25" "50" ; do
                ...
                for cur_run in "1" "2" "3" "4" "5" ; do
                    ...
                    # sh wrapper_cluster_run_model.sh \
                    # sh ./run_model.sh \
                    sbatch -J ccvae_noise_${cur_noise_lvl}_trust_${cur_trustset_lvl}_run_${cur_run} ./wrapper_cluster_run_model_bin.sh \
                        --dataset "simple_shapes" \
                        --model "semi_y_CCVAE" \
                        --epochs "200" \
                        --run-number "${cur_run}" \
                ...
                for cur_run in "1" "2" "3" "4" "5" ; do
                    ...
                    for exper_type in "dist_corr_on" "dist_corr_off" ; do
                        ...
                        if [[ ${exper_type} = "dist_corr_on" ]]; then
                            # sh ./run_model_bin.sh \
                            sbatch -J our_noise_${cur_noise_lvl}_trust_${cur_trustset_lvl}_run_${cur_run}_${exper_type} ./wrapper_cluster_run_model_bin.sh \
                                --dataset "simple_shapes" \
